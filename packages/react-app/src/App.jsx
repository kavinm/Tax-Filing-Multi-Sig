  ...
  */
  ...
  return (
    <div className="App">
      ...
      <Header style={{ positon: "absolute", top: 0, left: 0, backgroundColor: "red", width: 50 }} setRoute={setRoute} />
      {networkDisplay}
      <BrowserRouter>
        {/* TODO: Placement Menu on toggle, (only on Dev) */}
      ...
      {/* TODO: Temp removed using display: "none", */}
